$(document).ready(function(e) {
    ...
    $("#defaultCountdown").countdown({
        ...
        until: new Date(2016, 05, 18) /* defnisco la mia data, a quanto pare è settata per circa un mese indietro */
    });
    ...
    if ($('#map-canvas').length) {
        ...
        map.drawOverlay({
            lat: 43.719941,
            lng: 10.397234,
            content: '<div class="mapmarker"><i class="fa fa-map-marker"></i><br/><span>Talk e Workshop</span></div>',
        ...
        map.drawOverlay({
            lat: 43.719388,
            lng: 10.400178,
            content: '<div class="mapmarker"><i class="fa fa-map-marker"></i><br/><span>Dojo in Piazza</span></div>',
            verticalAlign: 'bottom',
            horizontalAlign: 'center'
        });
